class Level2 extends Phaser.Scene {
    ...
    create() {
      ...
      this.player1 = this.createPlayer(40, 400, "player1");
      this.player2 = this.createPlayer(this.map.widthInPixels - 40, 500, "player2");
      ...
      this.scoreText1 = this.add.text(10, 10, "", {
        font: "24px Courier",
        fill: "#00ff00",
      });
      this.scoreText2 = this.add.text(this.scale.width - 130, 10, "", {
        font: "24px Courier",
        fill: "#f3ce45",
      });
      ...
      this.enemyBird1 = this.physics.add.sprite(
        this.scale.width,
        this.scale.height - 650,
        "bird"
      );
      ...
      this.enemyBird2 = this.physics.add.sprite(
        0,
